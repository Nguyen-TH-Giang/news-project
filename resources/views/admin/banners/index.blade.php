                            ...
                            <div class="card top-selling overflow-auto">
                                <div class="card-body">
                                    <div class="card-title row g-3">
                                        <div class="col-md-8"><a href="{{ route('admin.banners.create') }}" class="btn btn-primary">Add new banner</a></div>
                                        <div class="col-md-4">
                                            <form class="row g-3" method="GET" action="#">
                                                <div class="col-md-12 d-flex flex-row">
                                                  ...
                                                  <a href="{{ route('admin.banners.index') }}" class="btn btn-danger rounded-pill ms-1"><i class="bi bi-arrow-clockwise"></i></a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($banners as $banner)
                                                <tr>
                                                    ...
                                                    <td>{{ $banner->status }}</td>
                                                    <td>
                                                        <a class="btn btn-primary" href="/admin/banners/{{ $banner->id }}/edit">
                                                            <i class="bi bi-pencil-square"></i></a>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#bannerModal-{{ $banner->id }}">
